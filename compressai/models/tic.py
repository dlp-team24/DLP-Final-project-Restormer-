...
# TIC with two Restormer Block using MLP rather GDFN ver.2 (g_a5, g_a7, g_s0, g_s2)
class TICwRSBwMLP_v2(nn.Module):
    """
    Modified from TIC (Lu et al., "Transformer-based Image Compression," DCC2022.)
    """
    def __init__(self, N=128, M=192, prompt_config=None, input_resolution=(256,256), in_channel=3):
        ...
        self.g_a4 = conv(N, N, kernel_size=3, stride=2)
        self.g_a5 = nn.Sequential(*[RestormerBlock2(dim=N,
                                                   num_heads=num_heads[2],
                                                   bias=False,
                                                   LayerNorm_type='WithBias',
                                                   mlp_ratio=mlp_ratio,
        ...
        self.g_s2 = nn.Sequential(*[RestormerBlock2(dim=N,
                                                   num_heads=num_heads[3],
                                                   bias=False,
                                                   LayerNorm_type='WithBias',
                                                   mlp_ratio=mlp_ratio,
